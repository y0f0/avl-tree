...
class TestBST(TestCase):
    ...
    def test_insert(self):
        ...
        print(self.bst.root.data, self.node0.data)
        ...
        assert (self.bst.root.right.right.data == self.node5.data)
        self.bst.insert(self.node4.data)
        assert (self.bst.root.right.right.left.data == self.node4.data)
        self.bst.insert(self.node2.data)
        assert (self.bst.root.right.left.data == self.node2.data)
        self.bst.insert(self.node1.data)
        assert (self.bst.root.right.left.left.data == self.node1.data)

        self.bst.insert(self.node_4.data)
        assert (self.bst.root.left.data == self.node_4.data)
        self.bst.insert(self.node_5.data)
        assert (self.bst.root.left.left.data == self.node_5.data)
        self.bst.insert(self.node_2.data)
        assert (self.bst.root.left.right.data == self.node_2.data)
        self.bst.insert(self.node_3.data)
        assert (self.bst.root.left.right.left.data == self.node_3.data)
        self.bst.insert(self.node_1.data)
        assert (self.bst.root.left.right.right.data == self.node_1.data)
